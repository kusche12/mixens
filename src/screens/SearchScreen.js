...
const KEYS_TO_FILTERS = ['title', 'tags.title', 'ingredients.ingredient'];
...
class SearchScreen extends React.Component {
  ...
  render() {
    ...
    const filteredMixes = this.props.drinks.filter(
    ...
    return (
      <SafeAreaView>
        <SearchFilter
          ...
          handleInput={(searchTerm) => this.setState({ searchTerm })}
        />
